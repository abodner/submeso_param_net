...
submeso_dataset=dataset.SubmesoDataset(['grad_B','FCOR', 'HML', 'TAU',
              'Q', 'HBL', 'div', 'vort', 'strain'],res='1_4', loc_num=index)
...
train_loader=DataLoader(
    ...
    num_workers=10,
    batch_size=64,
    sampler=SubsetRandomSampler(submeso_dataset.train_loc_ind))

test_loader=DataLoader(
    submeso_dataset,
    num_workers=10,
    batch_size=len(submeso_dataset.test_loc_ind),
    sampler=submeso_dataset.test_loc_ind)
...
save_name='fcnn_k5_l7_m_loc_'+str(index)+'_res_1_4.pt'
